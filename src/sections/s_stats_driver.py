...
STATS_SECTIONS = [
    ...
    {
        "id": "S.STATS.PROJECT_STATUS",
        "module": s_stats_project_status,
    },
    {
        "id": "S.STATS.TOP_CONTRIBUTORS_SEASON",
        "module": s_stats_top_contributors_season,
    },
]
...
def build_section(args=None):
    ...
    # ✅ Returnera manifest så produce_section blir nöjd
    return {
